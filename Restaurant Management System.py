...
lblfries = Label(f1, font=( 'aria' ,16, 'bold' ),text="Breakfast Meal",fg="steel blue",bd=10,anchor='w')
...
lblCheese_burger = Label(f1, font=( 'aria' ,16, 'bold' ),text="Dinner Meal",fg="steel blue",bd=10,anchor='w')
...
def price():
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Breakfast Meal", fg="steel blue", anchor=W)
    lblinfo.grid(row=1, column=0)
    ...
    lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Dinner Meal", fg="steel blue", anchor=W)
